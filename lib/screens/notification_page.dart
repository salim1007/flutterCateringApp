              ...
              Container(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    int newNoficationCount = await DioProvider()
                        .getNotifications(authModel.getAuthUserID,
                            authModel.getAuthUserToken);
                    authModel.updateNotificationCount(newNoficationCount);
                    MyApp.navigatorKey.currentState!.pushNamed(
                        'notification_layout',
                        arguments: authModel.user['user_notes']);
                  },
                  child: NotificationCard(
                    userNotifications: authModel.user['user_notes'],
